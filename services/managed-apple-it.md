...
redirect_from:
  - /itservices.html
  - /macs_for_business.html
  - /office365_for_business.html
  - /services.html
  - /services/
  - /software.html
layout: service-hub
...
hero:
  ...
  badges:
    ...
    - "%YEARS_SINCE_2012% years of Apple-first business operations"
...
faq:
  ...
  - q: "What is the typical engagement length?"
    a: "Annual agreements at minimum. Most clients stay multi-year because the relationship pays back at compound interest. The first year is the one where the foundation gets installed. Subsequent years are the ones where the foundation pays back."
  - q: "Do you support hybrid and remote staff?"
    a: "Yes. The MDM platform manages a Mac regardless of where it sits. Identity-based access, encrypted disks, and remote support tooling all work the same in a coffee shop, a client site, or a home office. The managed engagement assumes hybrid by default."
...
<div class="hub-video">
<video controls playsinline preload="none" width="100%" poster="/images/services/RIPEDA-Managed-Macs.png">
  <source src="/images/services/RIPEDA-Managed-Macs.mp4" type="video/mp4" />
  <source src="/images/services/RIPEDA-Managed-Macs.mov" type="video/quicktime" />
...
[Read more about the shape of a Managed Apple IT month →](/resources/insights/shape-of-a-managed-apple-it-month/)
...
[Read more about Apple Business Manager: what's actually involved →](/resources/insights/apple-business-manager-whats-involved/)

[Read more about MDM beyond the enrollment screen →](/resources/insights/mdm-beyond-enrollment/)

[See this in practice: the Calgary Public Library case study →](/case-studies/calgary-public-library/)
