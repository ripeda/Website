...
tags:
  ...
  - Identity
  - Strategy
keywords: "it problems when a company hits 20 employees, when should a small firm hire an msp, small firm it growing pains, first client security questionnaire, employee onboarding and offboarding checklist, professional services IT Calgary, Apple consulting Calgary"
reading_time: 3
author: "RIPEDA"
tldr:
  - "Founder-run IT does not fail loudly. It becomes interrupt-driven work that lands during billable hours."
  - "Informal access management stops being auditable somewhere around twenty people, and device inventory stops being accurate before that."
  - "Onboarding and offboarding change from occasional events into a process that needs writing down."
  - "The first client security questionnaire is usually when the gap turns from an annoyance into a revenue problem."
related:
  - title: "Six to 150: the IT debt that catches every SaaS post-Series A"
    url: "/resources/insights/saas-series-a-it-debt/"
    context: "The same problem viewed across a full growth curve, and what it costs to fix late."
  - title: "Strategy & Advisory"
    url: "/services/strategy-advisory/"
    context: "How firms at this size decide what to fix first and what can wait another year."
  - title: "Apple IT for Professional Services"
    url: "/industries/professional-services/"
    context: "What managed Apple IT looks like inside a growing consulting, accounting or legal-adjacent firm."
---
